...
const data = {
  ...
  painPoints: {
    ...
    sub: "Selling on Amazon and Flipkart is fine for volume — but it's not building your brand. These are the blockers we hear from D2C founders week after week.",
    items: [
      "Selling on marketplaces only — no direct channel, no customer data, no brand equity, and 15–30% commission bleed.",
      "Checkout experience on current website is clunky and slow — mobile users are abandoning at 70%+ rates.",
      "No personalisation or loyalty system — customers buy once and never return because there's nothing to bring them back.",
      "Inventory sync across Shopify, Amazon, Meesho, and physical stores is done manually in spreadsheets — overselling daily.",
      "No data on customer behaviour, repeat purchase patterns, or cohort LTV — marketing decisions are guesswork.",
      "WhatsApp is where customers are, but there's no commerce flow — just broadcast messages that nobody reads.",
    ],
  },
  ...
  appTypes: {
    ...
    items: [
      ...
      { title: "Product Recommendation Engine", desc: "AI-powered recommendations — 'Customers also bought', 'Complete the look', personalised homepage, and smart cart upsell widgets." },
  ...
  services: [
    ...
    { icon: <FaPenNib size={20} />, text: "Conversion-optimised UI/UX design — A/B tested checkout flows and PDP layouts" },
  ...
  process: [
    { step: "01", title: "Discovery", desc: "We audit your current conversion funnel, customer journey, and tech stack — then define what to build and in what order for fastest ROI." },
