...
const data = {
  ...
  painPoints: {
    ...
    items: [
      "No platform to deliver live or recorded classes at scale — Zoom links sent on WhatsApp is not a product.",
      ...
      "No mobile app — students are forced to attend only on laptop or desktop, creating friction and drop-off.",
  ...
  appTypes: {
    ...
    items: [
      ...
      { title: "Parent-Teacher Communication App", desc: "Structured communication portal — announcements, homework alerts, meeting booking, and report card sharing." },
  ...
  process: [
    ...
    { step: "02", title: "Design", desc: "Learner-first UI/UX — interfaces designed for students of all ages and comfort levels with technology." },
