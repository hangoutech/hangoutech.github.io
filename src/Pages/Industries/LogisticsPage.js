...
const data = {
  ...
  painPoints: {
    ...
    items: [
      "Fleet tracking done through phone calls and manual logbooks — no real-time visibility into where your vehicles are.",
      "No real-time visibility into shipment location for customers — leading to constant enquiry calls and eroded trust.",
  ...
  appTypes: {
    ...
    items: [
      ...
      { title: "Driver App with Digital POD", desc: "Mobile app for drivers — delivery manifests, navigation, digital proof-of-delivery (photo, signature, OTP), and cash collection management." },
      { title: "Transport Management System (TMS)", desc: "End-to-end freight management — load planning, carrier allocation, freight costing, consignment tracking, and billing reconciliation." },
  ...
  process: [
    { step: "01", title: "Discovery", desc: "We map your current dispatch, tracking, and billing workflows — identifying where manual processes are creating the most delay and cost." },
  ...
  faqs: [
    { q: "Can your software integrate with existing GPS hardware we already have?", a: "Yes. We support integration with most common GPS tracker protocols — including GT06N, Teltonika, Concox, and custom MQTT streams. If your devices send a TCP/UDP data packet, we can parse and display it on our map dashboard." },
